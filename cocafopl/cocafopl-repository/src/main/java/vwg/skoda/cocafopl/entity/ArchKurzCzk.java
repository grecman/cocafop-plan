...
/**
 * The persistent class for the GZ40T_KURZ_CZK database table.
 * 
 */
@Entity
...
public class ArchKurzCzk implements Serializable {
	...
	@Id
//	@SequenceGenerator(name="GZ40T_KURZ_CZK_ID_GENERATOR", sequenceName="COCAFOPPL_ARCH.HIBERNATE_SEQUENCE")
