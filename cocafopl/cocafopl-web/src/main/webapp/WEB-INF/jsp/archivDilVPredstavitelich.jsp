...
<body class="pages">
	<div class="page basePage">
		...
		<c:set scope="request" var="selectedSubMenu" value="dilVPredstavitelych" />
		...
		<div class="pageBody">
			<div class="mainAreaWide">
				<div class="formBar">
					<c:choose>
						<c:when test="${empty archKalkulaceRRRRMM}">
							<form:form commandName="archKalkulace" action="${pageContext.servletContext.contextPath}/srv/archiv/dilVPredstavitelich/param">
								<SPAN>&#160;Kalkulace:&#160;</SPAN>
								<SPAN>
						...
						<c:otherwise>
							<SPAN>&#160;Kalkulace:&#160;</SPAN>
							<a href="${pageContext.servletContext.contextPath}/srv/archiv/dilVPredstavitelich">
					...
					<c:if test="${not empty archKalkulaceRRRRMM}">
						<SPAN>
							<form:form commandName="archKusyProvView" id="formId" action="${pageContext.servletContext.contextPath}/srv/archiv/dilVPredstavitelich/list">
				...
				<c:if test="${not empty archDilVPredList}">
						...
						<table class="dataTable" id="tableId" style="table-layout: fixed;">
							...
							<thead>
								<tr>
									...
									<th style="font-size: x-small;">Modelová třída</th>
									<th style="font-size: x-small;">Produkt</th>
									...
									<th style="font-size: x-small;">Závod dílu</th>
							...
							<tbody>
								<c:forEach items="${archDilVPredList}" var="i">
									<tr>
