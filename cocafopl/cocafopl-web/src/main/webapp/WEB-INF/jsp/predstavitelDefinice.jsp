...
<script>
	...
	$(document).ready(function() {
		...
		$("#doplnitMinCisloButton").click(function() {
			$(window.location).attr('href', '${pageContext.servletContext.contextPath}/srv/predstavitel/definice/doplnitMinuleCisloPredstavitele');
		});
...
<body class="pages">
			...
			<div class="mainAreaWide">
									...
									<tr>
										...
										<td align="center"><c:choose>
												<c:when test="${(mt.platnostOd > i.platnostOd)}">
													<SPAN style="background-color: red;"> ${i.platnostOd}</SPAN>
												</c:when>
												<c:otherwise>
													${i.platnostOd}
												</c:otherwise>
				...
				<c:if test="${(not(empty(vybranaMtZavod)))}">
					<div class="formBar">
						...
						<span><a href="${pageContext.servletContext.contextPath}/srv/predstavitel/definice/novyForm"><input type="button" value="Nový" class="heroBtn"></input></a></span>
						...
						<c:if test="${not(empty(listPredstavitelu))}">
							...
							<span><a href="#openModalMinuleCisloPred"><input type="button" value="Doplnit min.číslo" class="heroBtn" title="Doplnit minulé číslo představitele"></input></a></span>
						</c:if>
					</div>
				</c:if>
			</div>
	...
	<div id="openModalSmazat" class="modalWindow">
		<div class="obalovak">
			...
			<div class="modalContent">Opravdu chcete smazat tohoto představitele?</div>
	...
	<div id="openModalMinuleCisloPred" class="modalWindow">
		<div class="obalovak">
			...
			<div class="modalContent">Po potvrzení aplikace doplní do "Minulé číslo představitele" z prosince předchozího roku, a to pouze u představitelů, kde je toto pole brazdné a kde se podaří najít předchozího představitele (tzn. stejná modelová třída + kód země).</div>
			<div class="modalFooter">
