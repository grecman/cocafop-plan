					...
					<TABLE style="padding-left: 15px;">
						...
						<TR>
							...
							<TD><SPAN style="font-size: 15px;">${modelovaTrida.modelTr}</SPAN> <form:input path="modelovyKlic" id="modelovyKlic4" class="textovePole"
									cssStyle="width:45px"></form:input><SPAN style="font-size: 15px;">(${modelovaTrida.zavod})</SPAN><SPAN style="font-size: x-small; color: gray;">&#160;
									Zadat pouze poslední čtyři znaky modelového klíče.</SPAN></TD>
						</TR>
						<TR>
