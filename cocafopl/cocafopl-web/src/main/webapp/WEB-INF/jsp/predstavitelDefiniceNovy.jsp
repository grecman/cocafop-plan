			...
			function() {
				$("#formButton").click(
						function() {
							...
							var mt = (!$("#modelovyKlic4").val().match(/^[a-zA-Z0-9]{4}$/) ? "Modelový klíč je špatně zadán: ${modelovaTrida.modelTr} " + $("#modelovyKlic4").val() + "\n" : "");
					...
					<TABLE style="padding-left: 15px;">
						...
						<TR>
							...
							<TD><SPAN style="font-size: 15px;">${modelovaTrida.modelTr}</SPAN> <form:input path="modelovyKlic" id="modelovyKlic4" class="textovePole"
									cssStyle="width:45px"></form:input>
						...
						<TR>
							...
							<TD><form:input path="kodZeme" id="kodZeme" value="${modelovaTrida.kodZeme}" class="textovePole" cssStyle="width:30px"></form:input>
								<SPAN style="font-size: x-small; color: gray;">&#160;Přednastavená hodnota z modelové třídy.</SPAN></TD>
						</TR>
						<TR>
						...
						<TR>
							...
							<TD><form:input path="vybavy" id="vybavy" class="textovePole" cssStyle="width:800px"></form:input>
